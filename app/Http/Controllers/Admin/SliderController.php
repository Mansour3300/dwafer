...
class SliderController extends Controller
{
    ...
    public function store(SliderRequest $request)
    {
        ...
        return response()->json(['status'=>'success','message'=>'you added new slide successfully']);
    }
    ...
    public function update(SliderRequest $request, string $id)
    {
        ...
        return response()->json(['status'=>'success','message'=>'you updated slide successfully']);
    }
    ...
    public function destroy(string $id)
    {
        ...
        $slide->delete();
        return response()->json(['status'=>'success','message'=>'slide just deleted']);
    }
}
