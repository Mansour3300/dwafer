...
class BlogController extends Controller
{
    ...
    public function store(BlogRequest $request)
    {
        ...
        return response()->json(['status'=>'success','data'=>null,'message'=>trans('auth.blog.you_just_created_post_successfully')]);
    }
    ...
    public function update(BlogRequest $request, string $id)
    {
        ...
        return response()->json(['status'=>'success','data'=>null,'message'=>trans('auth.blog.you_just_updated_post_successfully')]);
    }
    ...
    public function destroy(string $id)
    {
        ...
        $post->delete();
        return response()->json(['status'=>'success','data'=>null,'message'=>trans('auth.blog.post_just_deleted')]);
    }
}
