...
class ProfileController extends Controller
{
    ...
    public function store(ProfileRequest $request)
    {
        ...
        return response()->json(['status'=>'success','message'=>'you made your profile']);
    ...
    public function update(ProfileRequest $request, string $id)
    {
        ...
        return response()->json(['status'=>'success','message'=>'you updated your profile']);
    }
    ...
    public function destroy(string $id)
    {
        ...
        $profile->delete();
        return response()->json(['status'=>'success','message'=>'profile just deleted']);
    }
}
